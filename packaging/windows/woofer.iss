...
;
;   iscc /DVersion=0.1.4 /DArch=x86_64 /DBinary=...\woofer.exe ^
;        /DOutputDir=dist packaging\windows\woofer.iss
;
...
#define AppName "Woofer"
#define AppExeName "woofer.exe"
...
AppPublisherURL=https://github.com/kreatzzz/woofer
AppSupportURL=https://github.com/kreatzzz/woofer/issues
AppUpdatesURL=https://github.com/kreatzzz/woofer/download/
...
LicenseFile=..\..\LICENSE
OutputDir={#OutputDir}
OutputBaseFilename=woofer-v{#Version}-{#Arch}-pc-windows-msvc-setup
SetupIconFile=woofer.ico
