...
With a Free account Woofer can browse the library but not play it, and
says so at sign-in.
...
We are not aware of a Spotify account being suspended for using Woofer
...
Woofer does not rip tracks or block ads.

Reported suspensions usually involve modded apps that remove ads from free
accounts, track ripping, or stream manipulation. Woofer does none of
...
woofer previous            woofer shuffle [on|off]
woofer seek 15             woofer repeat [off|context|track]
woofer seek -- -15         woofer like
woofer seek-to 90          woofer play-uri spotify:playlist:37i9…
woofer show                woofer transfer <device-id>
woofer now-playing [--raw] woofer devices [--raw]
```
...
A verb exits non-zero when Woofer is not running.
