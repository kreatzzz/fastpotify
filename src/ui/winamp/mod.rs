//! The Winamp window: a classic skin's main window, as Woofer's own
...
//! same actions as the player bar. Woofer has no equalizer and no
...
mod tests {
    ...
    fn the_marquee_names_the_song_the_way_winamp_did() {
        ...
        assert_eq!(marquee_text(None, None, None, None, None), "Woofer");
