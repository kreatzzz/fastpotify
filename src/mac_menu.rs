...
mod mac_impl {
    ...
    define_class!(
        ...
        #[name = "WooferMenuHandler"]
        pub struct WooferMenuHandler;

        impl WooferMenuHandler {
    ...
    pub fn init() {
        ...
        let handler: Retained<WooferMenuHandler> =
            unsafe { objc2::msg_send![mtm.alloc::<WooferMenuHandler>(), init] };
